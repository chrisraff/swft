...
//					+ "Section number: " + snumber + "\\n"
		...
		tr += "SUMMARY:" + section + " " + number + " -" + name + ", " + type + "\n";
		tr += "TRANSP:OPAQUE\n"; //this seems to indicate that the event is "busy" aka not free time
		String uidTail = section + "-" + number + name + "-" + type;
